...
public class Popperbloom : Item<Popperbloom>
{
    ...
    {
        PopperseedsChanceInit = config.ActiveBind("Item: " + ItemName, "Proc chance with one " + ItemName, 10f, "The % chance of hits applying Popperseeds with one Popperbloom.");
        PopperseedsChanceStack = config.ActiveBind("Item: " + ItemName, "Proc chance per stack after one " + ItemName, 10f, "The % chance of hits applying Popperseeds per stack of Popperbloom after one.");
